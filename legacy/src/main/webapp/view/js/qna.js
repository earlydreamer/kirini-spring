            ...
            answers: [
                {
                    ...
                    author: '기키고수',
                    createdAt: '2025-05-20',
                    content: '문서 작업과 게임을 겸하신다면 갈축이나 저소음 적축을 추천드립니다. 갈축은 구분감이 있어 타건의 재미가 있고, 저소음 적축은 조용하면서도 부드러운 타건감을 제공합니다. 해당 예산으로 레오폴드, 바밀로, 덱 같은 브랜드 제품을 알아보시면 좋을 것 같아요.'
                },
                {
                    id: 'ans1-2',
                    author: '겜돌이77',
                    createdAt: '2025-05-21',
                    content: '배그 하시면 반응속도 빠른 은축도 고려해보세요! 다만, 은축은 입력 지점이 짧아서 오타가 좀 날 수 있습니다. 타건샵에서 직접 쳐보시는 걸 추천해요.'
                }
            ]
        },
        {
            ...
            answers: [
                {
                    ...
                    content: '필수는 아니지만, 윤활을 하면 스위치의 서걱임이나 스프링 소음을 줄여주고, 타건감을 더 부드럽고 정갈하게 만들어줍니다. 초보자분들은 붓윤활보다는 스프레이 윤활이 간편할 수 있지만, 효과는 붓윤활이 더 좋습니다. 유튜브에 관련 영상 많으니 참고해보세요!'
                }
            ]
        },
        {
            ...
            answers: [
                {
                    ...
                    content: '가장 큰 차이는 입력 방식입니다. 기계식은 물리적인 접점으로 입력되지만, 무접점은 정전용량 변화를 감지하여 입력됩니다. 그래서 무접점이 내구성이 더 좋고, 특유의 보글보글하거나 초콜릿 부러뜨리는 듯한 타건감을 가지고 있죠. 대표적으로 리얼포스, 한성무접점 등이 있습니다.'
                },
                {
                    id: 'ans3-2',
                    author: '앱코사랑',
                    createdAt: '2025-05-16',
                    content: '요즘은 앱코나 COX에서도 가성비 좋은 무접점 키보드가 많이 나와요. 타건감은 개인 취향이 많이 타니, 직접 타건해보시는 게 제일 좋습니다.'
                },
                {
                    id: 'ans3-3',
                    author: '키보드연구원',
                    createdAt: '2025-05-17',
                    content: '소음 면에서는 무접점이 기계식보다 전반적으로 조용한 편입니다. 물론 기계식도 저소음 축을 사용하면 조용하지만, 무접점 특유의 정숙함이 있죠.'
                }
            ]
        },
        {
            ...
            answers: [
                {
                    ...
                    content: '가장 중요한 건 스위치 종류(MX 호환인지)와 키보드 배열(표준 배열인지, 특수 배열인지)입니다. 스테빌라이저 형태(체리식, 마제식)도 확인해야 하고요. 키캡 프로파일은 높이나 모양에 따라 타건감에 영향을 주니, 선호하는 프로파일을 찾아보시는 것도 좋습니다. 보통 상품 상세페이지에 호환 정보가 나와있으니 잘 확인해보세요.'
                }
            ]
        },
        {
