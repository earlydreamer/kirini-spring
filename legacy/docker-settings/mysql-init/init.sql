...
-- keyboard_score
ALTER TABLE `keyboard_score`
    ADD CONSTRAINT `FK_keyboard_information_TO_keyboard_score`
        FOREIGN KEY (`keyboard_information_uid`) REFERENCES `keyboard_information` (`keyboard_information_uid`);
ALTER TABLE `keyboard_score`
    ADD CONSTRAINT `FK_user_TO_keyboard_score`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- freeboard_comment
ALTER TABLE `freeboard_comment`
    ADD CONSTRAINT `FK_freeboard_TO_freeboard_comment`
        FOREIGN KEY (`freeboard_uid`) REFERENCES `freeboard` (`freeboard_uid`);
ALTER TABLE `freeboard_comment`
    ADD CONSTRAINT `FK_user_TO_freeboard_comment`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- user_penalty
ALTER TABLE `user_penalty`
    ADD CONSTRAINT `FK_user_TO_user_penalty`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- chatboard
ALTER TABLE `chatboard`
    ADD CONSTRAINT `FK_user_TO_chatboard`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- log_delete_comment
ALTER TABLE `log_delete_comment`
    ADD CONSTRAINT `FK_user_TO_log_delete_comment`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- log_delete_post
ALTER TABLE `log_delete_post`
    ADD CONSTRAINT `FK_user_TO_log_delete_post`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- log_recommend
ALTER TABLE `log_recommend`
    ADD CONSTRAINT `FK_user_TO_log_recommend`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- log_modify_comment
ALTER TABLE `log_modify_comment`
    ADD CONSTRAINT `FK_user_TO_log_modify_comment`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- keyboard_information
ALTER TABLE `keyboard_information`
    ADD CONSTRAINT `FK_keyboard_category_TO_keyboard_information`
...
-- news
ALTER TABLE `news`
    ADD CONSTRAINT `FK_user_TO_news`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- keyboard_taglist
ALTER TABLE `keyboard_taglist`
    ADD CONSTRAINT `FK_keyboard_tag_TO_keyboard_taglist`
        FOREIGN KEY (`tag_uid`) REFERENCES `keyboard_tag` (`tag_uid`);
ALTER TABLE `keyboard_taglist`
    ADD CONSTRAINT `FK_keyboard_information_TO_keyboard_taglist`
        FOREIGN KEY (`keyboard_information_uid`) REFERENCES `keyboard_information` (`keyboard_information_uid`);

-- freeboard
ALTER TABLE `freeboard`
    ADD CONSTRAINT `FK_user_TO_freeboard`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- scrap
ALTER TABLE `scrap`
    ADD CONSTRAINT `FK_user_TO_scrap`
        FOREIGN KEY (`scrap_user_uid`) REFERENCES `user` (`user_uid`);
ALTER TABLE `scrap`
    ADD CONSTRAINT `FK_keyboard_information_TO_scrap`
        FOREIGN KEY (`keyboard_information_uid`) REFERENCES `keyboard_information` (`keyboard_information_uid`);

-- report
ALTER TABLE `report`
    ADD CONSTRAINT `FK_user_report_TO_report`
        FOREIGN KEY (`report_user_uid`) REFERENCES `user` (`user_uid`);
ALTER TABLE `report`
    ADD CONSTRAINT `FK_user_target_TO_report`
        FOREIGN KEY (`target_user_uid`) REFERENCES `user` (`user_uid`);

-- news_comment
ALTER TABLE `news_comment`
    ADD CONSTRAINT `FK_news_TO_news_comment`
        FOREIGN KEY (`news_uid`) REFERENCES `news` (`news_uid`);
ALTER TABLE `news_comment`
    ADD CONSTRAINT `FK_user_TO_news_comment`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);

-- log_modify_post
ALTER TABLE `log_modify_post`
    ADD CONSTRAINT `FK_user_TO_log_modify_post`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);
...
ALTER TABLE `inquiry`
    ADD CONSTRAINT `FK_user_TO_inquiry`
        FOREIGN KEY (`user_uid`) REFERENCES `user` (`user_uid`);
ALTER TABLE `inquiry`
    ADD CONSTRAINT `FK_inquiry_TO_inquiry`
...
-- 전문 검색용 인덱스 (MySQL 기준)
CREATE
FULLTEXT INDEX idx_freeboard_title_contents
